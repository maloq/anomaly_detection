    ...
    def fit(self,
        ...
        for epoch in range(epochs):
            ...
            if save_every and network_model_path_base and epoch % save_every == 0:
                ...
                checkpoint_path = os.path.join(network_model_path_base, f'epoch_{epoch}.pt')
                os.makedirs(network_model_path_base, exist_ok=True)
        ...
        if network_model_path_base:
            os.makedirs(network_model_path_base)
