...
def get_args():
    ...
    parser.add_argument('--annotation_path', default="train_annotations.txt",
                        help="path to train annotation")
    parser.add_argument('--log_file', type=str, default="log.log",
                        help="set logging file.")
    parser.add_argument('--exps_dir', type=str, default="exps",
                        help="set logging file.")
    parser.add_argument('--save_name', type=str, default="model_MFnets_1_01_2048_SubNormal",
    ...
    parser.add_argument('--batch_size', type=int, default=2048,
                        help="batch size")
    parser.add_argument('--feature_dim', type=int, default=6144,
                        help="batch size")
